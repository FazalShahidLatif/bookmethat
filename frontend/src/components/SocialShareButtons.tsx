    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1a8cd8] transition text-sm font-medium"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#1877F2] text-white rounded-lg hover:bg-[#166fe5] transition text-sm font-medium"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#0A66C2] text-white rounded-lg hover:bg-[#004182] transition text-sm font-medium"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#20bd5a] transition text-sm font-medium"
