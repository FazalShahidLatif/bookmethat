...
export const metadata: Metadata = {
  title: 'Sign In to bookmethat - Access Your Bookings & Rewards',
  description: 'Sign in to your bookmethat account to manage bookings, track rewards, and access exclusive travel deals.',
  keywords: ['sign in', 'login', 'account access', 'my bookings'],
};
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to access your bookings and rewards</p>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500 mb-4">Trusted by 2M+ travelers worldwide</p>
